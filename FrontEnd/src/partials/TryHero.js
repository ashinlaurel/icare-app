...
const TryHero = () => {
  return (
    <section class="bg-gray-100 dark:bg-gray-800 font-business ">
      <div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center mt-16">
        <div class="w-full lg:w-1/2">
          <div class="lg:max-w-lg">
            <h1 class="text-3xl  font-bold text-gray-800 leading-tight dark:text-white lg:text-5xl">
              IT Consulting & Services
            </h1>

            <div class="mt-8 space-y-5">
              <p class="flex items-center text-lg -mx-2 text-gray-700 dark:text-gray-200">
                <span class="mx-2 ">
          ...
          <div class="w-full mt-4 bg-transparent border rounded-md lg:max-w-sm dark:border-gray-700 focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 dark:focus-within:border-blue-400 focus-within:ring-opacity-40">
